        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MeetingRequests_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MeetingRequests_Users_ManagerId",
                        column: x => x.ManagerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MeetingRequests_Users_SecretaryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MeetingRequests_GroupId",
                table: "MeetingRequests",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_MeetingRequests_ManagerId",
                table: "MeetingRequests",
                column: "ManagerId");

            migrationBuilder.CreateIndex(
                name: "IX_MeetingRequests_SecretaryId",
                table: "MeetingRequests",
                column: "SecretaryId");
